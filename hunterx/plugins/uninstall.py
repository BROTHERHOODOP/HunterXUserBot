...
from hunterx.events import remove_plugin, load_module
...
async def unload(event):
    ...
    dir_path =f"./hunterx/plugins/{shortname}.py"
    try:
        remove_plugin(shortname)
        os.remove(dir_path)
        await event.edit(f"Uninstalled {shortname} successfully By HUNTER X")
    except OSError as e:
